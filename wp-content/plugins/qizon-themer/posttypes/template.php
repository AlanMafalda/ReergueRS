...
class Gavias_Themer_Template{
	...
	public function args_post_type_template(){
		$labels = array(
			'name'               => esc_html__( 'Template', 'qizon-themer' ),
			'singular_name'      => esc_html__( 'Template', 'qizon-themer' ),
			'add_new'            => esc_html__( 'Add Template', 'qizon-themer' ),
			'add_new_item'       => esc_html__( 'Add Template', 'qizon-themer' ),
			'edit_item'          => esc_html__( 'Edit Template', 'qizon-themer' ),
			'new_item'           => esc_html__( 'New Template', 'qizon-themer' ),
			'view_item'          => esc_html__( 'View Template', 'qizon-themer' ),
			'search_items'       => esc_html__( 'Search Template Profiles', 'qizon-themer' ),
			'not_found'          => esc_html__( 'No Template Profiles found', 'qizon-themer' ),
			'not_found_in_trash' => esc_html__( 'No Template Profiles found in Trash', 'qizon-themer' ),
			'parent_item_colon'  => esc_html__( 'Parent Template:', 'qizon-themer' ),
			'menu_name'          => esc_html__( 'Templates & Layout', 'qizon-themer' ),
		);
