...
class GVAElement_Icon_Box_Styles extends GVAElement_Base {  
   ...
   public function get_categories() {
	...
	public function get_title() {
		return __( 'Icon Box Styles', 'qizon-themer' );
	}
	...
	protected function register_controls() {
		$this->start_controls_section(
			'section_icon',
			[
				'label' => __( 'Icon Box Style', 'qizon-themer' ),
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'options' => [
					...
					'style-3' 		=> __( 'Style III', 'qizon-themer' )
				],
				'default' => 'style-1',
			]
		);
		...
		$this->add_control(
			'title_text',
			[
				'label' => __( 'Title & Description', 'qizon-themer' ),
				'type' => Controls_Manager::TEXT,
				'default' => __( 'This is the heading', 'qizon-themer' ),
		...
		$this->add_control(
			...
			[
				...
				'default' => __( 'There are many new variations of pasages of available text.', 'qizon-themer' ),
		...
		$this->add_responsive_control(
			'icon_padding',
			[
				'label' => __( 'Icon Padding', 'qizon-themer' ),
				'type' => Controls_Manager::DIMENSIONS,
				'size_units' => [ 'px'],
				'selectors' => [
