...
class GVAElement_Circle_Progress extends GVAElement_Base {
   ...
   public function get_categories() {
	...
	public function get_title() {
		return __( 'Circle Progress', 'qizon-themer' );
	}
	...
	protected function register_controls() {
		...
		$this->add_control(
			...
			[
				...
				'default'	  => esc_html__( 'Organic Foods Provides', 'qizon-themer' )
			]
		);
		$this->add_control(
			'empty_fill',
			[
				'label' => __( 'Color EmptyFill', 'qizon-themer' ),
		...
		$this->add_control(
			'number',
			[
			  	'label' => __( 'Percentage', 'qizon-themer' ),
			  	'type' => Controls_Manager::NUMBER,
				'min' => 5,
			  	'max' => 100,
			  	'step' => 1,
	 	...
	 	$this->add_control(
			'thickness',
			[
			  	'label' => __( 'Thickness', 'qizon-themer' ),
			  	'type' => Controls_Manager::NUMBER,
				'min' => 1,
			  	'max' => 50,
			  	'step' => 1,
		...
		$this->add_control(
			'percentage_color',
			[ 
				'label' => __( 'Percentage Color', 'qizon-themer' ),
				'type' => Controls_Manager::COLOR,
				'selectors' => [
