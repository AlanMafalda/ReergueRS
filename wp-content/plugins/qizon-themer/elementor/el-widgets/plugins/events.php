...
class GVAElement_Events extends GVAElement_Base{
	...
	public function get_title() {
		return __('GVA Events', 'qizon-themer');
	}
	...
	protected function register_controls() {
		...
		$this->add_control(
			...
			[
				...
				'options' => [
					...
					'event_start_date' => __( 'Event Start Date', 'qizon-themer' ),
		...
		$this->add_control(
			'event_display',
			[
				'label'   => __( 'Event Display', 'qizon-themer' ),
				'type'    => Controls_Manager::SELECT,
				'default' => '',
				'options' => [
					'' => __( 'All', 'qizon-themer' ),
					'upcoming'  => __( 'Upcoming', 'qizon-themer' )
				],
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'options' => [
					'event-1'     => __( 'Event Item Style I', 'qizon-themer' )
				],
				'default' => 'event-1',
				'condition' => [
