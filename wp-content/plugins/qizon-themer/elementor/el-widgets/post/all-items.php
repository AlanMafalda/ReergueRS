...
class GVAElement_Posts extends GVAElement_Base{
	 ...
	 public function get_title() {
		  return __('Posts All Items', 'qizon-themer');
	 }
	 ...
	 protected function register_controls() {
		  ...
		  $this->add_control( // xx Layout
			...
			$this->add_control(
				...
				[
					 ...
					 'default' => 'carousel',
					 'options' => [
						  'standard'      => __('Standard', 'qizon-themer'),
						  'grid'          => __('Grid', 'qizon-themer'),
						  'carousel'      => __('Carousel', 'qizon-themer'),
						  'small_list'    => __('Small List', 'qizon-themer'),
						  'sticky'        => __('Post Large & List', 'qizon-themer')
					 ]
				]
		  );
		  $this->add_control(
				...
				[
					 ...
					 'options' => [
						  'post-style-1'         => __('Item Post Style I', 'qizon-themer'),
						  'post-style-2'         => __('Item Post Style II', 'qizon-themer'),
						  'post-style-3'         => __('Item Post Style III', 'qizon-themer')
					 ],
					 'condition' => [
		  	...
		  	$this->add_control(
				...
				[
					...
					'options' => [
					  	...
					  	'menu_order' => __('Menu Order', 'qizon-themer'),
		  	...
		  	$this->start_controls_section(
				...
				[
					'label' => __('Right List Posts Style', 'qizon-themer'),
		  	...
		  	$this->add_responsive_control(
				'stick_list_padding',
				[
					'label' => __('Padding List Posts', 'qizon-themer'),
		  	...
		  	$this->add_control(
				...
				[
					'label' => __('Background List Posts', 'qizon-themer'),
		  	...
		  	$this->add_control(
				...
				[
					'label' => __('List Posts Title Color', 'qizon-themer'),
					'type' => Controls_Manager::COLOR,
					'default' => '',
					'selectors' => [
		  	...
		  	$this->add_control(
				...
				[
					'label' => __('List Posts Meta Color', 'qizon-themer'),
					'type' => Controls_Manager::COLOR,
					'default' => '',
					'selectors' => [
		  ...
		  $this->start_controls_section(
				...
				[
					 'label' => __('Post Description', 'qizon-themer'),
					 'tab'   => Controls_Manager::TAB_STYLE,
					 'condition' => [
						  'layout' => ['grid', 'carousel']
					 ],
