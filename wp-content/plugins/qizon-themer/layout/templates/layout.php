   ...
   <div class="gva-template-content">
      ...
      <?php 
         ...
         if(class_exists('WPCF\Crowdfunding')){
            require_once('parts/crowdfunding_single.php'); 
            require_once('parts/crowdfunding_archive.php'); 
         }
      ...
      <div id="gva-ajax-loadding" class="ajax-message" style="opacity: 0;">
         <div class="content">
            <img src="<?php echo GAVIAS_QIZON_PLUGIN_URL ?>/layout/assets/loading.gif"/>
         </div>  
      </div>

      <div id="gva-ajax-success" class="ajax-message" style="opacity: 0;">
         <div class="content-inner" style="text-align: center;">
            <img src="<?php echo GAVIAS_QIZON_PLUGIN_URL ?>/layout/assets/animated-check.gif"/>
            <h2><?php echo esc_html__('Changes saved successfully', 'qizon-themer') ?></h2>
         </div>  
      </div>
