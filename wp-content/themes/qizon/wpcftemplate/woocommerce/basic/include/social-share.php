...
?>
    <?php if( is_array( $social ) ){ ?>
        <?php if( !empty( $social ) ){ ?>
            ...
            <div class="social-container">
                <span class="title"><?php echo esc_html__('Share: ','qizon'); ?></span>
                <div class="links">
                    ...
                    <?php } ?>
                    <?php if( $embed ){ ?>
                        <a href="javascript:void(0)" class="embedlink" data-postid="<?php echo the_permalink($post_id); ?>"><i class="wpneo-icon wpneo-icon-embed" data-postid="<?php echo esc_attr($post_id); ?>"></i></a>
                    <?php } ?>
                </div>
            </div>
    ...
    <?php if( !$enable_social && $embed ){ ?>
        <div class="social-container">
            <span><?php _e('Share: ','qizon'); ?></span>
            <div class="links">
                <a href="javascript:;" class="embedlink" data-postid="<?php echo the_permalink($post_id); ?>"><i class="wpneo-icon wpneo-icon-embed" data-postid="<?php echo esc_attr($post_id); ?>"></i></a>
            </div>
        </div>
    <?php } ?>