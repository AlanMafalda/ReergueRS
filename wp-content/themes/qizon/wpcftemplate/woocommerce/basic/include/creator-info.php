...
<div class="wpneo-campaign-creator-info-wrapper">
    <div class="wpneo-campaign-creator-avatar">
        <?php if ( $post->post_author ) {
            ...
            <?php if( $img_src ){ ?>
                <img width="80" height="80" src="<?php echo esc_url($img_src); ?>" alt="<?php echo esc_esc__('Creator', 'qizon') ?>">
            <?php } else { ?>
    ...
    <div class="wpneo-campaign-creator-details">
        <div class="creator-name">
            <span><?php echo esc_html__( 'By', 'qizon' ) ?></span>
            <a href="javascript:;" data-author="<?php echo esc_attr($post->post_author); ?>" class="wpneo-fund-modal-btn" ><?php echo wpcf_function()->get_author_name(); ?></a>
        </div>
        <div class="creator-meta">
            <?php echo wpcf_function()->author_campaigns($post->post_author)->post_count; ?>
            <?php echo esc_html__("Campaigns","qizon"); ?> | <?php echo wpcf_function()->loved_count(); ?>
            <?php echo esc_html__('Loved campaigns', 'qizon'); ?>
        </div>
