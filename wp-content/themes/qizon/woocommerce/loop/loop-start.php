 ...
 */
   ...
   $columns_lg = qizon_get_option('product_columns_lg', $std_lg);
   $columns_md = qizon_get_option('product_columns_md', $std_md);
   $columns_sm = qizon_get_option('product_columns_sm', $std_sm);
   $columns_xs = qizon_get_option('product_columns_xs', $std_xs);
?>
